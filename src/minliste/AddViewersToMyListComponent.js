      ...
      <div className={classes.root}>
        <NoSsr>
          <Select
            ...
            styles={selectStyles}
            textFieldProps={{
              label: 'Hvem skal kunne se denne listen:',
              InputLabelProps: {
                shrink: true,
              },
            }}
...
export default connect(mapStateToProps, null)(withStyles(styles, { withTheme: true })(AddViewersToMyListComponent));
